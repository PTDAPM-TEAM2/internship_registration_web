...
import styles from './DLGVTT.module.css';
            ...
            {showAlert &&
                <div>
                    <Alert severity="success" sx={{
                        ...
                        <AlertTitle>Tạo tài khoản giảng viên hướng dẫn thực tập thành công !</AlertTitle>
                    </Alert>
                </div>}
            <div className={styles.form}>

                <p className={styles.title}>Nhập dữ liệu giảng viên từ Excel</p>
                <div className={styles.body}>
                    <div className={styles.cover}>
                        ...
                        <label htmlFor="file" className={styles.label}>+ Nhập dữ liệu giảng viên từ Excel</label>
